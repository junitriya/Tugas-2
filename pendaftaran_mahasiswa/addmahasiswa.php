...
if (isset($_POST['btn-save'])) {
 ...
 if ($kelolauser->insertData($nama, $nim, $password)) {
...
<div class="container-fluid">
 ...
 <div class="collapse navbar-collapse" id="navbarCollapse">
   <ul class="navbar-nav me-auto mb-2 mb-md-0">
     <li class="nav-item">
       <a class="nav-link" aria-current="page" href="indexmahasiswa.php">Pengelolaan Data</a>
     </li>
     <li class="nav-item">
...
<a href="indexmahasiswa.php" class="btn btn-large btn-secondary btn-sm">Kembali</a>    
...
<div class="panel-body">
 ...
 <form method='post'>
     <table class='table table-bordered'>
         ...
         <tr>
             <td>Nim</td>
             <td><input type='nim' name='nim' class='form-control' required></td>
         </tr>
